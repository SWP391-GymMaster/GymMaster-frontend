  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#f9f9ff] px-4 py-8 text-[#191b23]">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -right-32 -top-32 h-[34rem] w-[34rem] rounded-full bg-[#d8e2ff]/80 blur-3xl" />
      ...
      <section className="relative z-10 w-full max-w-[640px] rounded-xl border border-[#e1e2ec] bg-white/85 p-6 text-center shadow-[0_20px_80px_rgba(25,27,35,0.08)] backdrop-blur-xl md:p-12">
        <div className="mx-auto mb-8 flex size-20 items-center justify-center rounded-full bg-[#2170e4] text-white shadow-[0_16px_40px_rgba(0,88,190,0.25)]">
          <Dumbbell aria-hidden="true" className="size-10" />
        </div>
        <div className="mx-auto mb-4 inline-flex rounded-full border border-[#c2c6d6]/60 bg-[#f2f3fd] px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.12em] text-[#0058be]">
          System Initialized
        </div>
        <h1 className="text-4xl font-bold tracking-tight text-[#191b23] md:text-5xl">
          Welcome to GymMaster OS
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-base leading-7 text-[#424754] md:text-lg">
          Secure role-aware operations for front desk staff, trainers,
          administrators, and members.
        </p>
        <div className="mt-10 flex flex-col justify-center gap-3 sm:flex-row">
          <Link
            className="inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-[#0058be] px-6 text-base font-semibold text-white shadow-sm transition hover:bg-[#2170e4] hover:shadow-md active:scale-[0.98]"
            href="/login"
          >
            Get Started
