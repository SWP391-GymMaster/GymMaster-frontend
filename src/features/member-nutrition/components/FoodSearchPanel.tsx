            ...
            <div>
              ...
              <div className="flex gap-2 mt-2">
                ...
                <Button
                  ...
                  className="min-h-12 aspect-square shrink-0 rounded-full border border-border/80 bg-[var(--surface-panel)] text-muted-foreground transition hover:bg-muted active:scale-[0.98]"
                  variant="outline"
