...
Define GymMaster's installable, privacy-preserving Progressive Web App behavior, including platform-aware installation, service-worker isolation, safe caching, honest offline states, user-controlled updates, and verification requirements.
